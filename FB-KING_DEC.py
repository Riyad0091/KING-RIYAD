...
rgen=f' {K}[{RED}√{K}] {P}'
wt=f' {K}[{GREEN}?{K}] {P}'
fst=f'{dot}[{H}sathi{M}={H}abir{M}={H}tisha{M}={H}RIYAD{M}={H}samim{P}]'
...
def banner():
   ...
   \
\x1b[38;5;46m'______ _______   _____ ______   _   _______ _   _ ____
..   ........... '| ___ \_   _\ \ / / _ \|  _  \ | | / /_   _| \ | |  __ \
\x1b[38;5;46m'| |_/ / | |  \ V / /_\ \ | | | | |/ /  | | |  \| | |  \/
\x1b[38;5;46m'|    /  | |   \ /|  _  | | | | |    \  | | | . ` | | __ 
\x1b[38;5;46m'| |\ \ _| |_  | || | | | |/ /  | |\  \_| |_| |\  | |_\ \
   \033[1;35m'\_| \_|\___/  \_/\_| |_/___/   \_| \_/\___/\_| \_/\____/
...
def mainx():
    ...
    print(f'{K} [{H}8{K}] {N}Contract RIYAD-KING')
    print(f"{K} [{M}0{K}] {WHITE}Exit Tools ");print(led)
    RIYAD = input(f'{wt}Select menu {M}:{H} ')
    if RIYAD in ["1","01"]:
        exit()
    elif RIYAD in ["2","02"]:
        exit()
     ...
     print(f'{gen}{RED}Exited {H}RIYAD-KING {P}Terminal ');os.system("xdg-open https://www.facebook.com/profile.php?id=100074768487367" );exit()
    else:
     print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://www.facebook.com/profile.php?id=100074768487367");mainx()
def mainx2():
    os.system("clear")
    banner()
...
def sep():
    ...
    print(led);print(f'{dot}Total File Ids {M}:{H} ' +
          str(len(open(file_name).read().splitlines())));print(led);print(f'{gen}Example {M}:{H} /sdcard/RIYAD.txt');print(led)
...
def dupcutter():
    os.system('clear');banner();print(f'{dot}Example   {RED}:{H} /sdcard/RIYAD.txt');print(led)
    Error = input(f"{wt}{N}File Name {RED}:{H} ");print(led);print(f'{dot}Example   {RED}:{H} /sdcard/RIYAD.txt');print(led)
...
def x7():
  ...
  input(f'{dot}Press Enter To Go Menu');os.system('python RIYAD-KING.py')
...
if __name__=='__main__':
  try:os.mkdir('KING-RIYAD')
  except:pass
  try:os.mkdir('QUEEN-NAIMA')
  except:pass
#  b2()
#  mainx() 
  mainx()
